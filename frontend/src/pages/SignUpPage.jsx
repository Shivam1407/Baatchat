    ...
    return (
        < div className='h-screen flex items-center justify-center p-4 sm:p-6 md:p-8' data-theme="dark" >
            <div className='border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden'>
                            ...
                            <div className='space-y-4'>
                                <div>
                                    ...
                                    <p className='text-sm opacity-70'>
                                        Join BaatChat and start your language learning adventure!
                                    </p>
                                </div>
                                ...
                                <div className='space-y-3'>
                                    ...
                                    <div className='form-control w-full'>
                                        ...
                                        <input type='text'
                                            placeholder='yourpalshivam@gmail.com'
                                            className='input input-bordered w-full'
                ...
                {/*  Signup form image- right side*/}
                <div className='hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center'>
                    <div className="max-w-md p-8">
                        {/* Illustration */}
                        <div className='relative aspect-square max-w-sm mx-auto'>
                            <img src="/Sign up-amico.png" alt="Language connection illustration" className='w-full h-full' />
